  ...
  const fetchBankBranches = async () => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        console.log("Filtered Banks:", bankLedgers); // Debugging

        // Flatten structure: Ensure subLedgers exist
        const allBranches = bankLedgers.reduce((acc, bank) => {
          if (!bank.subLedgers) return acc; // Avoid errors if subLedgers is missing
          return [
            ...acc,
        ...
        console.log("Processed Branches:", allBranches); // Debugging
